 ...
 */
export class UniformInstanceArcBufferAnts extends BaseBuffer <CurvedLineShape<any> | CurvedLineShape<any>[], Mesh> {
  /**
   * @override
   * See interface definition
   */
  init(material: ShaderMaterial, unitCount: number, shared?: UniformInstanceArcBufferAnts) {
  ...
  update(shapeBuffer: CurvedLineShape<any>[] | CurvedLineShape<any>[][], atlasManager?: AtlasManager, controlPointSource?: number) {
    ...
    BufferUtil.updateUniformBuffer(
      ...
      (
        ...
        const antLength = curve.marchingAnts.strokeLength + curve.marchingAnts.gapLength;
