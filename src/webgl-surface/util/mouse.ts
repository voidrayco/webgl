...
function normalizeFirefoxWheel(e: WheelEvent) {
  const wheel: WheelEvent = e as WheelEvent;
  let deltaX = 0;
  let deltaY = 0;
...
function normalizeChromeWheel(e: WheelEvent) {
  const wheel: WheelEvent = e as WheelEvent;

  return new Vector2(wheel.deltaX, -wheel.deltaY);
}

function normalizeIE11Wheel(e: WheelEvent) {
  const wheel: WheelEvent = e as WheelEvent;
...
function normalizeIE12Wheel(e: WheelEvent) {
  const wheel: WheelEvent = e as WheelEvent;
...
let normalizeWheel: (e: WheelEvent) => Vector2;
