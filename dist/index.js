...
O = t[0], T = t[1], A = t[2], B = t[3], R = t[4], E = t[5], L = t[6], z = t[7], D = t[8], U = t[9], j = t[10], Q = e[0], $ = e[1], J = e[2], K = e[3], tt = e[4], et = e[5], rt = e[6], nt = e[7], ot = e[8], it = e[9], st = e[10];
} function o(t, e) {
for (let r = at; r < t; ++r)N = r * Q, e(r - at, O, N)
;} function i(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, e(r - at, O, N, T, k)
;} function s(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, e(r - at, O, N, T, k, A, X)
;} function a(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, e(r - at, O, N, T, k, A, X, B, W);
} function u(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, e(r - at, O, N, T, k, A, X, B, W, R, F);
} function c(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y);
} function h(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, V = r * rt, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y, L, V)
;} function l(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, V = r * rt, q = r * nt, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y, L, V, z, q)
;} function f(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, V = r * rt, q = r * nt, H = r * ot, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y, L, V, z, q, D, H);
} function d(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, V = r * rt, q = r * nt, H = r * ot, Z = r * it, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y, L, V, z, q, D, H, U, Z);
} function p(t, e) {
for (let r = at; r < t; ++r)N = r * Q, k = r * $, X = r * J, W = r * K, F = r * tt, Y = r * et, V = r * rt, q = r * nt, H = r * ot, Z = r * it, G = r * st, e(r - at, O, N, T, k, A, X, B, W, R, F, E, Y, L, V, z, q, D, H, U, Z, j, G)
;} function y(t) {
M = t[0] || 0, P = t[1] || 0, I = t[2] || 0, S = t[3] || 0
;} function m(t, e) {
t[e] = M;
} function g(t, e) {
t[e] = M, t[++e] = P;
...
t[e] = M, t[++e] = P, t[++e] = I
;} function v(t, e) {
t[e] = M, t[++e] = P, t[++e] = I, t[++e] = S;
}Object.defineProperty(e, '__esModule', {value:!0}); let x = r(0), 
_ = r(2),
 w = r(2)('WebGLSurface:BufferUtil'); !(function(t){t[t.CW=0]="CW",t[t.CCW=1]="CCW",t[t.DEGENERATE=2]="DEGENERATE"})(e.TriangleOrientation || (e.TriangleOrientation = {})); let C; !(function(t){t[t.ONE=0]="ONE",t[t.TWO=1]="TWO",t[t.THREE=2]="THREE",t[t.FOUR=3]="FOUR"})(C = e.AttributeSize || (e.AttributeSize = {})); var M = 0,
 P = 0,
 I = 0, 
S = 0, 
O = [], 
...
st = 0,
 at = 0,
 ut = !1, 
ct = (ft = {}, ft[C.ONE] = m, ft[C.TWO] = g, ft[C.THREE] = b, ft[C.FOUR] = v, ft),
 ht = {1:o, 2:i, 3:s, 4:a, 5:u, 6:c, 7:h, 8:l, 9:f, 10:d, 11:p}, 
lt = (function(){function t(){}return t.beginUpdates=function(){ut=!0,at=0},t.dispose=function(t){t&&t.forEach(function(t){t.attributes=null,t.currentData=null,t.geometry.dispose(),t.geometry=null,t.system=null})},t.endUpdates=function(){var t=at;return ut=!1,at=0,t},t.examineBuffer=function(t,e,r){var n=_(r);if(n.enabled){var o=t.attributes,i=t.geometry,s=o.map(function(t){return i.attributes[t.name]}),a=s.map(function(t){return t.array}),u=[];if(t.system.drawMode===x.TrianglesDrawMode)for(var c=0,h=0,l=0,f=i.drawRange.start+i.drawRange.count;c<f;)!function(){for(var t={vertex_0:{},vertex_1:{},vertex_2:{}},e=0;e<3;++e)!function(e){o.forEach(function(r,n){h=r.size+1,l=c*h,t["vertex_"+e][r.name]=a[n].slice(l,l+h)}),c++}(e);u.push(t)}();else if(t.system.drawMode===x.TriangleStripDrawMode)for(var d=0,p=0,y=0,m=i.drawRange.start+i.drawRange.count;d<m;)!function(){for(var t={vertex_0:{},vertex_1:{},vertex_2:{}},e=0;e<3;++e)!function(e){o.forEach(function(r,n){p=r.size+1,y=d*p,t["vertex_"+e][r.name]=a[n].slice(y,y+p)}),d++}(e);d-=2,u.push(t)}();n(e||"vertices: %o uniforms: %o",{drawRange:i.drawRange,triangles:u},t.system.material.uniforms)}},t.flattenMultiBuffers=function(t){var e=[];return t.forEach(function(t){t.getBuffers().forEach(function(t){return e=e.concat(t)})}),e},t.updateMultiBuffer=function(t,e,r,n,o){var i=!1,s=t.getBuffers(),a=new Map;e.forEach(function(t){return a.set(t.bufferItems.currentData,t)});var u=[];if(o?u=[].concat(s):s.forEach(function(t){a.get(t)?a.delete(t):u.push(t)}),u.length>=a.size)a.forEach(function(t){i=n(t,u.shift())||i}),u.forEach(function(t){var o=r();e.push(o),i=n(o,t)||i});else{var c=Array.from(a.values());u.forEach(function(t){var e=c.shift();i=n(e,t)||i}),c.forEach(function(t){t.bufferItems.geometry.setDrawRange(0,0)})}return i},t.makeBuffer=function(t,e){for(var r=e.length,n=new x.BufferGeometry,o=0,i=0;i<r;++i){var s=e[i],a=s.size+1;o+=a;var u=new Float32Array(a*t),c=ct[s.size],h=s.name;y(s.defaults);for(var l=0;l<t;++l)c(u,l*a);n.addAttribute(h,new x.BufferAttribute(u,a)),w("Made Buffer Attribute:",h,a)}return o>16&&console.warn("A Buffer has specified more attributes than available. The max is 16 and the buffer provided:",o),n},t.updateBuffer=function(t,e,r,o,i,s){var a=e.attributes,u=e.geometry,c=0!==at&&ut;if(void 0!==t&&t!==e.currentData||c||s){ut||(at=0),e.currentData=t;var h=a.map(function(t){return u.attributes[t.name]});n(h.map(function(t){return t.array}),a.map(function(t){return(t.size+1)*r}));return(0,ht[a.length])(o+at,i),h.forEach(function(t){t.updateRange&&(t.updateRange.offset=0,t.updateRange.count=r*o),t.needsUpdate=!0}),at+=o,!0}return at+=o,!1},t.makeBufferItems=function(){return{attributes:[],currentData:[],geometry:null,system:null}},t})(); e.BufferUtil = lt; let ft
;}, function(t, e, r) {
