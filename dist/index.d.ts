...
//   ../../webgl-surface/buffers/static/simple-bezier-line-buffer
//   ../../webgl-surface/buffers/static/simple-circular-line-buffer
//   ../../webgl-surface/buffers/static/simple-label-buffer
...
export class ChordBaseCache extends ShapeBufferCache<CurvedLineShape<IChordData>> {
    ...
    /**
      ...
      * shapes simpler.
      */
    preProcessData(data: IData, config: IChordChartConfig, outerRings: OuterRingGenerator): ICurveData[];
}
...
export class ChordChartGL extends WebGLSurface<IChordChartGLProperties, {}> {
    interactiveBezierBuffer: SimpleStaticBezierLineBuffer;
    interactiveCircularBuffer: SimpleStaticCircularLineBuffer;
    staticBezierBuffer: SimpleStaticBezierLineBuffer;
    staticCircularBuffer: SimpleStaticCircularLineBuffer;
    staticLabelBuffer: SimpleStaticLabelBuffer;
    interactiveLabelBuffer: SimpleStaticLabelBuffer;
